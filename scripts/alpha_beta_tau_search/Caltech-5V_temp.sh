...
# ==================== 修改点1：直接定义需要补的6个参数组合 ====================
# 从日志文件名解析出的参数组合：
# 1. beta=0.01, tau=10000
# 2. beta=0.0005, tau=0
# 3. beta=0.1, tau=10000
# 4. beta=0.005, tau=10000
# 5. beta=0.001, tau=10000
# 6. beta=0.0005, tau=10000

# 使用数组存储需要运行的参数组合
declare -a PARAM_COMBINATIONS=(
    "0.01 10000"    # beta=0.01, tau=10000
    "0.0005 0"      # beta=0.0005, tau=0
    "0.1 10000"     # beta=0.1, tau=10000
    "0.005 10000"   # beta=0.005, tau=10000
    "0.001 10000"   # beta=0.001, tau=10000
    "0.0005 10000"  # beta=0.0005, tau=10000
)
...
echo "[INFO] 总共需要补的实验数: ${#PARAM_COMBINATIONS[@]}"
